defmodule Rumbl.MultimediaTest do
  ...
  describe "videos" do
    ...
    test "create_video/2 creates video" do
      owner = user_fixture()
      assert {:ok, %Video{}} = Multimedia.create_video(owner, @valid_attrs)
    end

    test "create_video/2 with invalid data does not create video" do
      owner = user_fixture()
    ...
    test "update_video/2 with valid data updates the video" do
      ...
      assert {:ok, video} = Multimedia.update_video(video, @valid_attrs)
    end

    test "update_video/2 with invalid data fails to create video" do
      owner = user_fixture()
      video = video_fixture(owner)
